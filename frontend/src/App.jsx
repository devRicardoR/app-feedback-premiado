...
function IconHome() {
    ...
    return (
        ...
        {exibirLayout && (
            <header className={`${headerFooterClass} shadow p-4 text-center font-semibold text-lg`}>Feedback Premiado</header>
        )}
        ...
        {exibirLayout && (
            ...
            <button onClick={handleHome} className="flex flex-col items-center focus:outline-none" aria-label="Home" title="Home">
                <IconHome />
                <span className="text-sm">Home</span>
            </button>
            <button onClick={handleEditarPerfil} className="flex flex-col items-center focus:outline-none" aria-label="Editar Perfil" title="Editar Perfil">
                <IconUser />
                <span className="text-sm">Editar Perfil</span>
            </button>
            <button onClick={handleLogout} className="flex flex-col items-center focus:outline-none" aria-label="Sair" title="Sair">
                <IconLogout />
